...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-17 23:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d7c1d48a-2841-499f-a6a2-d8230f8422a1.git
$ cd d7c1d48a-2841-499f-a6a2-d8230f8422a1
```
